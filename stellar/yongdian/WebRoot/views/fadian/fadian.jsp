...
<div class="ld_logo">
    <div class="ld_Wrap">
        ...
        <ul class="pull-right" role="tablist">
            ...
            <li role="presentation"><a href="#shouquan" aria-controls="home" role="tab" data-toggle="tab">网关授权</a></li>
...
<div class="tab-content">
        ...
        <div class="margin_top20">
            ...
            <div class="ld_content_list clearfix margin_top20">
                <div class="pull-left clearfix" id="maidian">
                    ...
                    <div class="pull-left dianliang">电量：
                        <div class="clearfix display_inlineBlock">
                            <input type="text" class="div_input" value="10000"/>
                ...
                <div class="pull-right text-right">
                    <input type="button" name="" id="" value="买入" class="ld_btn ld_btn_margin margin_top0 margin_bottom18 padding_l_r" />
                </div>
            </div>
        ...
        <div class="ld_content_list margin_top20">
            <form>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="faxingzhanghu" value="GDX4F7J2CWRD5UM5GPIFQW7UAYEKKNRQOFRDDGTFJSBBCFAMZACOFUII">
                </div>
                <div class="clearfix">
                    ...
                    <div class="zhonglei_list pull-left">
                        ...
                        <input type="button" class="ld_btn padding_l_r" value="设置" />
                    </div>
                </div>
            </form>
        </div>
    ...
    <div role="tabpanel" class="tab-pane fade ld_content" id="personal">
        ...
        <div class="ld_content   ld_content ld_Wrap  tab-content-padding" id="dizhi">
            <h3 class="content_title">
            ...
            <div class="ld_content_list clearfix margin_top20">
                <div class="fadiantongji clearfix">
                    <div class="pull-left margin_bottom18">
                        <div class="pull-left">
                            <h3 class="fadian_title1">发电量统计</p>
    ...
    <div role="tabpanel" class="tab-pane fade ld_content  ld_content ld_Wrap tab-content-padding" id="shouquan">
        <h3 class="content_title">网关授信 <span class="content_tips">(授信后才能充值或接收他人的转账)</span></h3>
        <div class="ld_content_list margin_top20">
            <form>
                <div class="form-group">
