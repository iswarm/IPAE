...
public class SendMailThread extends Thread{
    ...
    public void sendMail(String mailAdr,String subject,String content){
        ...
        props.put("mail.user", "291604136@qq.com");
        // 访问SMTP服务时需要提供的密码,不是邮箱登陆密码，一般都有独立smtp的登陆密码
        props.put("mail.password", "joygzuhdeothcaeh");
    ...
    public static void main(String[] args) {
        // TODO Auto-generated method stub
        SendMailThread d = new SendMailThread("1317275544@qq.com","测试邮件标题","测试邮件001 <br>内容....");
        d.start();
