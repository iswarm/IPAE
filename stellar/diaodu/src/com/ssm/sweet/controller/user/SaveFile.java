...
public class SaveFile {
    ...
    public ModelAndView saveFile (HttpServletRequest request, HttpServletResponse response){
        ...
        KeyPair pair1 = KeyPair.fromAccountId("GDJ457BQ3VTFDPHSRIUEVZDHOYL6OYOVLCGU5FSGLBXOJXFMEORR2XEF");
        SignerKey sing1 = pair1.getXdrSignerKey();
        KeyPair pair2 = KeyPair.fromAccountId("GBIORYPLZRSQEQ25OT2BNQATYTEJPNSUNIPII5CHOL2XEBFFZ6KAOTVU");
        SignerKey sing2 = pair2.getXdrSignerKey();
        KeyPair pair3 = KeyPair.fromAccountId("GA7OI7AJCBERNLDNZ4QQN2IADPTDBUJX6VKCHV3FZL5V27YFE2KCDTOQ");
        SignerKey sing3 = pair3.getXdrSignerKey();
        KeyPair pair4 = KeyPair.fromAccountId("GAODUO7B7XCRKCMBNSRFHN7P4YMEECMUI2EO3QNGSRJNTG3UA6D34FCJ");
        SignerKey sing4 = pair4.getXdrSignerKey();
        KeyPair pair5 = KeyPair.fromAccountId("GBUMJUT4YPKV74QZK4SMD6SRDCSFFHT4XPVVIVI5S3KWPTPKRTLHEMZ7");
        SignerKey sing5 = pair5.getXdrSignerKey();
        ...
        Transaction setAuthorization = new Transaction.Builder(issuing)
                ...
                .addOperation(new SetOptionsOperation.Builder()
                        ...
                        .build())
                .build();
        setAuthorization.sign(pair);
        System.out.println(setAuthorization.getSequenceNumber());
        try {
            server.submitTransaction(setAuthorization);
            System.out.println("Create of Succeses");
        } catch (IOException e) {
            System.out.println("Create of Lose");
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
        int len = skey.length();
    ...
    public static void WriteStringToFile(String key,String filePath) {
        try {
